...
public class SingleApplyActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (UICommon.INSTANCE.getmIdentity() == UICommon.TEACHER) {
            ...
            intent.setClassName(this, SingleApplyTeacherActivity.class.getName());
            startActivity(intent);
            this.finish();
        }

        setContentView(R.layout.activity_apply_single);
        ...
        switch (v.getId()) {
            ...
            case R.id.btApply:
                if (checkCanApply()) {
                    ...
                    System.out.println("teacher--------->" + tvTeacher.getTag());
                    if (mCompetitionDetail.getIsproof() == 1) {
                    ...
                    String url = "CompetitionController/applyRegister";
                        ...
                        public void sucessListener(String result) {
                            if (!result.isEmpty()) {
                                ...
                                if (general.getSuccess()) {
                                    AlertDialog dialog = new AlertDialog.Builder(SingleApplyActivity.this).setMessage(general.getMsg())
                                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                                @Override
                                                public void onClick(DialogInterface dialog, int which) {
                                                    SingleApplyActivity.this.finish();
                                                    dialog.dismiss();
                                                }
                                            }).create();
                                    dialog.show();
                                    ...
                                    if (general.getMsg().equals("未登录")) {
                                        UICommon.INSTANCE.toLogin(SingleApplyActivity.this);
                                    } else {
    ...
    private void initAcademyView(View contentView) {
        ...
        MyHttpRequest request = new MyHttpRequest(this, url, null) {
            ...
            public void sucessListener(String result) {
                ...
                if (list.getSuccess()) {
                    academyList.setAdapter(new AcademyAdapter(list, SingleApplyActivity.this));
                }
            }
        };
    ...
    private void initDepartmentView(View contentView, final Academy academy) {
        ...
        MyHttpRequest request = new MyHttpRequest(this, url, params) {
            ...
            public void sucessListener(String result) {
                ...
                if (list.getSuccess()) {
                    departmenList.setAdapter(new DepartmentAdapter(list, SingleApplyActivity.this));
                }
            }
        };
    ...
    private void initTeacherView(View contentView, Academy academy, Department department) {
        ...
        MyHttpRequest request = new MyHttpRequest(this, url, params) {
            ...
            public void sucessListener(String result) {
                ...
                if (list.getSuccess()) {
                    teacherList.setAdapter(new TeacherAdapter(list, SingleApplyActivity.this));
                }
            }
        };
        request.startRequestByPost();
